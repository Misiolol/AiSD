...
def print_graph_matrix(matrix):
    """Wypisuje macierz grafu w czytelnym formacie"""
    for row in matrix:
        print(" ".join(f"{cell:4}" for cell in row))
        
# Przykład 1 z prezentacji (slajd 18-20)
def example1():
    print("Przykład 1 (z prezentacji, slajd 18-20):")
    # Lista sąsiedztwa dla grafu z przykładu
    adj_list = {
        1: [2],
        2: [4, 5],
        3: [1, 2],
    ...
    # Tworzymy i wypisujemy macierz grafu
...
def example2():
    print("\nPrzykład 2 (z prezentacji, slajd 21-23) - multigraf:")
    # Lista sąsiedztwa dla multigrafu z przykładu
    adj_list = {
        1: [1, 5],
        2: [3, 5, 6, 7],
        3: [6],
