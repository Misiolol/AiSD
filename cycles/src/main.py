...
from .algo import HamiltonCycleVis, EulerCycleVis
            ...
            if clicked_button:
                ...
                if len(graph.vertex_dict) > 0:
                    if clicked_button.text == "HAMILTON CYCLE":
                        ...
                        hamilton.draw_hamilton_vis(win)
                    if clicked_button.text == "EULER CYCLE":
                        euler = EulerCycleVis(graph)
                        euler.draw_euler_vis(win)
